...
console.log(proximo)
    ...
    return(
        <>
          <div>
            <button className="absolute left-20 top-[100rem]  bg-white text-black font-bold p-2 rounded-full animate-slideIn // max-sm:left-8 max-sm:top-[115rem]  "
            onClick={anterior}
            > 
              {"<"}
            </button>
            <div className="flex w-screen h-screen justify-center items-center gap-5  animate-slideIn //  "> 
            ...
            <button className="absolute right-16 top-[100rem] bg-white text-black font-bold p-2 rounded-full animate-slideIn  max-sm:right-4  max-sm:top-[115rem] " 
            onClick={proximo}
            > 
              {">"}
            </button>
